...
#include "coder.h"
//#define __RAM__ __attribute__ ((section (".data")))
#define __RAM__
 ...
 */
 __RAM__ const int ISFMpeg1[2][7] = {
 ...
 */
 __RAM__ const int ISFMpeg2[2][2][16] = {
{
	{
